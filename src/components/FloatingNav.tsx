      ...
      <div className="hidden items-center justify-between gap-4 rounded-[8px] border border-white/10 bg-[#353e43]/95 px-4 py-3 text-sm text-white shadow-[0_18px_45px_rgba(0,0,0,0.45)] backdrop-blur lg:flex">
        <div className="flex items-center">
          <a
            ...
            className="grid h-12 w-12 place-items-center rounded-[8px] bg-gradient-to-br from-[#4169e1] to-[#001f54] text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.35),0_18px_35px_rgba(65,105,225,0.5)] transition hover:-translate-y-[2px] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white/70"
          >
        ...
        <div className="flex items-center gap-2">
          {quickActions.map((action) => (
            <a
              ...
              className="grid h-12 w-12 place-items-center rounded-[8px] border border-white/10 bg-gradient-to-br from-[#4169e1] to-[#001f54] text-lg text-white shadow-inner shadow-white/20 transition hover:translate-y-[-1px]"
            >
              {action.emoji}
            </a>
          ))}
...
function MobileActionButton({
  ...
  return (
    <a
      ...
      aria-label={label}
      onClick={onClick}
      className={`grid h-14 w-14 flex-shrink-0 place-items-center rounded-[8px] bg-gradient-to-br from-[#4169e1] to-[#001f54] text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.35),0_18px_35px_rgba(65,105,225,0.5)] transition focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white/70 ${
