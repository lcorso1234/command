export default function ValuesPage() {
  return (
    <div className="bg-[#353e43] text-white">
      <main className="mx-auto flex min-h-screen max-w-3xl flex-col gap-10 px-6 py-24 pb-44 text-[18px] leading-relaxed sm:px-8 sm:pb-48 lg:px-12">
        ...
        <section className="space-y-1">
          ...
          <p className="text-base text-white/80">Logic by iTech.</p>
        </section>
      </main>
    </div>
  );
